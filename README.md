...
python Zebrafish_LDM/ZebraFish_Segment_Anything.py --DATA_PATH=./Data/ --META_PATH=./Zebrafish_LDM/example.xlsx --OUT_PATH=./outputs -—SAM_PATH=./models/sam_vit_h_4b8939.pth 
